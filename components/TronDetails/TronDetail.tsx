...
export default function TronDetail({
  address = "TW6qxa65P1MCF1RYqY7e3Zg8GNAbWsp9Ce",
  conversionRate = "₦1605",
  minimumDeposit = "$5",
  showTruncated = false,
}) {
  ...
  const copyToClipboard = async () => {
    try {
      ...
      Alert.alert("Copied!", "TRON address copied to clipboard");
      ...
      <View style={styles.page}>
        <View style={styles.qrCodeContainer}>
          <QRCode
            ...
            color="black"
            logo={require("../../assets/images/tronicon.png")}
            logoSize={30}
        ...
        <View style={[styles.containerBase, styles.bitcoinAddressContainer]}>
          <View style={styles.warningRow}>
            ...
            <Text style={styles.warningText}>
              Send only TRON to this deposit address
            </Text>
          </View>
          ...
          <View style={styles.addressRow}>
            ...
            <TouchableOpacity
              ...
              accessibilityLabel="Copy Bitcoin address"
