...
export default function UsdtErcDetails({
  address = "3Q4e4s5u4omyyNsFoLdfL8P2vruTVSmhi65FqcYpbngf",
  conversionRate = "₦1600",
  minimumDeposit = "$5",
  showTruncated = false,
}) {
  ...
  const copyToClipboard = async () => {
    try {
      ...
      Alert.alert("Copied!", "ERC address copied to clipboard");
      ...
      <View style={styles.page}>
        <View style={styles.qrCodeContainer}>
          <QRCode
            ...
            color="black"
            logo={require("../../assets/images/usdt(ERC20).png")}
            logoSize={30}
        ...
        <View style={[styles.containerBase, styles.bitcoinAddressContainer]}>
          <View style={styles.warningRow}>
            ...
            <Text style={styles.warningText}>
              Send only USDT(ERC20) to this deposit address
            </Text>
          </View>
          ...
          <View style={styles.addressRow}>
            ...
            <TouchableOpacity
              ...
              accessibilityLabel="Copy ERC address"
              accessibilityHint="Copies the Bitcoin address to clipboard"
              activeOpacity={0.7}
            >
              <Ionicons
