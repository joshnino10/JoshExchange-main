...
export default function VerifyNewAccDetails() {
  ...
  const Bank = "Opay"
  const AccountNumber = "8149364188"
  const AccountName = "Joshua Nduka ifeanyi"
      ...
      <View style={styles.page}>
        <View style={styles.BankDetailsBox}>
          ...
          <View>
            ...
            <View style={styles.BankDetails}>
                <Text style={styles.lable}>Account Name: </Text>
