...
export default function GoogleGiftCard() {
  const [receiptType, setReceiptType] = useState<"PHYSICAL" | "ECODE">(
    "PHYSICAL"
  );
        ...
        >
          <View style={styles.header}>
            <Image
              ...
              source={require("../../assets/images/google card.png")}
            />
          </View>
              ...
              {["PHYSICAL", "ECODE"].map((type) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    receiptType === type && styles.receiptOptionActive,
                  ]}
                ...
                >
                  ...
                  <Text
                    style={[
                      ...
                      receiptType === type && styles.receiptOptionTextActive,
                    ]}
                  >
                    {type}
                  </Text>
