...
export default function UsdtTrcDetails({
      ...
      <View style={styles.page}>
        <View style={styles.qrCodeContainer}>
          <QRCode
            ...
            color="black"
            logo={require("../../assets/images/usdt(trc20).png")}
            logoSize={30}
        ...
        <View style={[styles.containerBase, styles.bitcoinAddressContainer]}>
          ...
          <View style={styles.addressRow}>
            ...
            <TouchableOpacity
              ...
              accessibilityLabel="Copy TRC address"
              accessibilityHint="Copies the TRC address to clipboard"
              activeOpacity={0.7}
            >
              <Ionicons
